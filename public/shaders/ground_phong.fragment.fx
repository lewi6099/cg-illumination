...
void main() {
    ...
    vec3 specular_light = max(light_colors[0] * max(pow(dot(R, normalized_view_direction), 0.0), mat_shininess), vec3(0.0)); // makes the top of the box white and the sides of the sphere white
